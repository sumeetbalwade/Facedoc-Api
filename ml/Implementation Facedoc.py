...
path = "D:/Project/facedoc-api/uploads/dataset/raw/"
newPath = "D:/Project/facedoc-api/uploads/dataset/data/"


folder = []

# dirs=directories
for (root, dirs, file) in os.walk(newPath):
    for f in dirs:
        folder.append(f)
...
os.chdir('D:/Project/facedoc-api/uploads/dataset/data')
if os.path.isdir('D:/Project/facedoc-api/uploads/dataset/data/train/Ik') is False:
...
train_path = 'D:/Project/facedoc-api/uploads/dataset/data/train'
valid_path = 'D:/Project/facedoc-api/uploads/dataset/data/valid'
test_path = 'D:/Project/facedoc-api/uploads/dataset/data/test'
...
model.save('C:/Users/ASUS/Downloads/facedoc/Facedoc_ML/models/MobileNet.h5')
